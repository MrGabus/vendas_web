...
namespace VendasWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed() 
        {
            ...
            Seller s1 = new Seller(1, "Joao Carlos", "joao@gmail.com", new DateTime(1998, 4, 21), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1970, 12, 05), 3500.0, d2);
            Seller s3 = new Seller(3, "Alex Silva", "alex@gmail.com", new DateTime(1990, 5, 10), 2200.0, d1);
            Seller s4 = new Seller(4, "Julia Adriana", "julia@gmail.com", new DateTime(2000, 10, 01), 3000.0, d4);
            Seller s5 = new Seller(5, "Adriana Carlos", "adriana@gmail.com", new DateTime(1987, 6, 15), 4000.0, d3);
            Seller s6 = new Seller(6, "Amanda Silva", "amanda@gmail.com", new DateTime(1975, 5, 12), 3000.0, d2);
